...
public class CategoriaSetps {
	...
	public void oAppApresentaAsDuasCategoriasCriadas() {
	   assertEquals("Categoria Um", driver.findElement(By.xpath("//android.widget.TextView[@text='Categoria Um']")).getText());
	   assertEquals("Categoria Dois", driver.findElement(By.xpath("//android.widget.TextView[@text='Categoria Dois']")).getText());
	}
