...
public class ListaSteps {
	...
	public void oAppExibeACategoriaDaLista() {
		assertEquals("Categoria da Lista", driver.findElement(By.xpath("//android.widget.TextView[@text='Categoria da Lista']")).getText());
	}
	...
	public void oAppExibeAListaComOTituloEditado() {
	    assertEquals("Lista Editada", driver.findElement(By.xpath("//android.widget.TextView[@text='Lista Editada']")).getText());
	}
